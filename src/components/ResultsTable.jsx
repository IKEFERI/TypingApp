...
const ResultsTable = () => {
    ...
    if (results){
        return (
            ...
            <Table className={classes.table} size="middle" aria-label="a dense table">
                <TableHead>
    ...
    return <Paper style={{padding: '16px', fontSize: '18px', fontWeight: '700'}}>Попыток еще не было.</Paper>
